...
public sealed class AuthorizationCodeFlowEndpointShapeTests
{
    ...
    /// <summary>
    /// AuthorizeがJSON形式のログインURLと認可リクエストCookieを返すことを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Authorizeが未登録client_idをinvalid_clientとして拒否することを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// AuthorizeがJSON応答指定なしの場合にログイン画面へリダイレクトすることを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Authorizeがopenidを含まないscopeをinvalid_scopeとして拒否することを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Loginがユーザー認証後に認可コード付きredirect_urlを返すことを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Loginが誤ったパスワードをunauthorizedとして拒否することを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Loginが未登録メールアドレスをunauthorizedとして拒否することを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Loginがformのrequest_id未指定時にAuthRequestId Cookieを使用することを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Loginがrequest_id未指定かつCookieなしの場合にbad requestを返すことを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Loginが不正なメールアドレス形式をbad requestとして拒否することを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Tokenが有効な認可コードとPKCE verifierでBearer token responseを返すことを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Tokenが不一致のPKCE verifierをinvalid_grantとして拒否し、no-storeヘッダーを付与することを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Tokenが未対応grant_typeをbad requestとして拒否することを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Tokenが認可コードと一致しないclient_idをinvalid_grantとして拒否することを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Tokenが認可コードと一致しないredirect_uriをinvalid_grantとして拒否することを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Tokenがgrant_type未指定をbad requestとして拒否することを確認する。
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// authorize endpoint呼び出し用のquery stringを設定する。
    /// </summary>
    ...
    /// <summary>
    /// HttpContextにform-urlencoded bodyを設定する。
    /// </summary>
    ...
    /// <summary>
    /// IActionResultが200 OKであることを検証して返す。
    /// </summary>
    ...
    /// <summary>
    /// IActionResultが指定ステータスのErrorOutputであることを検証して返す。
    /// </summary>

...
public sealed class InMemoryUserStore
{
    ...
    /// <summary>
    /// メールアドレスとパスワードを持つユーザーを作成する。
    /// </summary>
    /// <param name="email">ログインに使用するメールアドレス。</param>
    /// <param name="password">ログインに使用するパスワード。</param>
    /// <param name="name">ユーザー表示名。</param>
    /// <param name="subject">指定がある場合に使用するsubject。未指定時は自動生成する。</param>
    /// <returns>作成済みユーザーレコード。</returns>
